...
public class ImageViewUtil {
	 ...
	 */
	public static Rect getBitmapRectCentserInside(Bitmap bitmap, View view) {
	 ...
	 * @return the rectangular position of the Bitmap
	 */
	public static Rect getBitmapRectCensterInside(int bitmapWidth,
	...
	public static Rect getBitmapRectFitCenter(Bitmap bitmap, View view) {
		...
		final int viewWidth = view.getWidth();
		final int viewHeight = view.getHeight();
		return getBitmapRectFitCenterHepler(bitmapWidth, bitmapHeight,
				viewWidth, viewHeight);
	}
	...
	public static Rect getBitmapRectFitCenterHepler(int bitmapWidth,
			int bitmapHeight, int viewWidth, int viewHeight) {
		double resultWidth;
		double resultHeight;
		int resultX;
		int resultY;
		double viewToBitmapWidthRatio = (double) viewWidth
				/ (double) bitmapWidth;
		double viewToBitmapHeightRatio = (double) viewWidth
				/ (double) bitmapWidth;
		if (viewToBitmapWidthRatio <= viewToBitmapHeightRatio) {
			resultWidth = viewWidth;
			resultHeight = (bitmapHeight * resultWidth / bitmapWidth);
