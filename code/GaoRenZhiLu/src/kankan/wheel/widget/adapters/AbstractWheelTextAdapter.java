...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
	...
	/** Default text size */
	public static int DEFAULT_DIVIDER_HEIGHT = 0;
	...
	// item的间距
	protected int dividerHeight = DEFAULT_DIVIDER_HEIGHT;
	...
	static {
		try {
			...
			AbstractWheelTextAdapter.DEFAULT_TEXT_SIZE = wheelTextSize;
			AbstractWheelTextAdapter.DEFAULT_DIVIDER_HEIGHT = divider;
		} catch (Exception e) {
	...
	public View getItem(int index, View convertView, ViewGroup parent) {
		if (index >= 0 && index < getItemsCount()) {
			...
			if (0 < dividerHeight) {
				textView.setPadding(0, dividerHeight, 0, dividerHeight); // TODO
																			// 这只Item间距
			}
			if (textView != null) {
